...
@Component
public class LoginTrans implements VoRiTransChecked<Login, LoginDto, RiCheckerException, LoginChecker> {
	...
	@Override
	public LoginDto voToDtoImpl(Login vo) throws RiCheckerException {
