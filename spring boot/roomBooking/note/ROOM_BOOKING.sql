...
(
	...
	CONSTRAINT HOTEL_FEATURE_NAME_UNIQUE UNIQUE (NAME)
);

COMMENT ON COLUMN HOTEL_FEATURE.ID IS '飯店特色編號';
COMMENT ON COLUMN HOTEL_FEATURE.NAME IS '飯店特色名字';
...
INSERT INTO HOTEL_FEATURE (ID, NAME) VALUES (HOTEL_FEATURE_SEQ.NEXTVAL, '房內免費Wi-Fi');
INSERT INTO HOTEL_FEATURE (ID, NAME) VALUES (HOTEL_FEATURE_SEQ.NEXTVAL, '停車場');
INSERT INTO HOTEL_FEATURE (ID, NAME) VALUES (HOTEL_FEATURE_SEQ.NEXTVAL, '可寄放行李');
...
(
	...
	CONSTRAINT HOTEL_ACCOUNT_ACCOUNT_UNIQUE UNIQUE (ACCOUNT)
);
...
(
	...
	CONSTRAINT HOTEL_ADDRESS_UNIQUE UNIQUE (ADDRESS),
	CONSTRAINT HOTEL_IMG_NAME_UNIQUE UNIQUE (IMG_NAME),
	CONSTRAINT HOTEL_ACCOUNT_ID_UNIQUE UNIQUE (ACCOUNT_ID),
    CONSTRAINT HOTEL_SECTION_CODE_FK FOREIGN KEY (SECTION_CODE) REFERENCES SECTION (CODE),
    CONSTRAINT HOTEL_HOTEL_ACCOUNT_ID_FK FOREIGN KEY (ACCOUNT_ID) REFERENCES HOTEL_ACCOUNT (ID)
);
...
(
	...
	CONSTRAINT HOTEL_FEATURE_JOIN_PK PRIMARY KEY (HOTEL_ID, FEATURE_ID),
    CONSTRAINT HOTEL_FEATURE_JOIN_HOTEL_ID_FK FOREIGN KEY (HOTEL_ID) REFERENCES HOTEL (ID),
    CONSTRAINT HOTEL_FEATURE_JOIN_FEATURE_ID_FK FOREIGN KEY (FEATURE_ID) REFERENCES HOTEL_FEATURE (ID)
);
...
(
	...
	CONSTRAINT SCENE_NAME_UNIQUE UNIQUE (NAME)
);
...
(
	...
	CONSTRAINT ROOM_SCENE_ID_FK FOREIGN KEY (SCENE_ID) REFERENCES SCENE (ID),
...
INSERT INTO ROOM (ID, NAME, TOTAL_NUM, INVALID_NUM, USED_NUM, PRICE, SINGLE_BED_NUM, DOUBLE_BED_NUM, AREA, SCENE_ID, HOTEL_ID) VALUES (ROOM_SEQ.NEXTVAL, '標準雙人房', 5, 1, 2, 1000, 2, 0, 13, 2, 2);
INSERT INTO ROOM (ID, NAME, TOTAL_NUM, INVALID_NUM, USED_NUM, PRICE, SINGLE_BED_NUM, DOUBLE_BED_NUM, AREA, SCENE_ID, HOTEL_ID) VALUES (ROOM_SEQ.NEXTVAL, '標準雙人房', 5, 1, 2, 1000, 2, 0, 13, 3, 3);
INSERT INTO ROOM (ID, NAME, TOTAL_NUM, INVALID_NUM, USED_NUM, PRICE, SINGLE_BED_NUM, DOUBLE_BED_NUM, AREA, SCENE_ID, HOTEL_ID) VALUES (ROOM_SEQ.NEXTVAL, '標準雙人房', 5, 1, 2, 1000, 2, 0, 13, 4, 4);
...
(
	...
	CONSTRAINT SHOWER_NAME_UNIQUE UNIQUE (NAME)
);
...
(
    ...
    CONSTRAINT ROOM_SHOWER_JOIN_ROOM_ID_FK FOREIGN KEY (ROOM_ID) REFERENCES ROOM (ID),
    CONSTRAINT ROOM_SHOWER_JOIN_SHOWER_ID_FK FOREIGN KEY (SHOWER_ID) REFERENCES SHOWER (ID)
);
...
(
	...
	CONSTRAINT ROOM_IMG_IMG_NAME_UNIQUE UNIQUE (IMG_NAME),
	CONSTRAINT ROOM_IMG_IMG_ORDER_ROOM_ID_UNIQUE UNIQUE (IMG_ORDER, ROOM_ID),
	CONSTRAINT ROOM_IMG_ROOM_ID_FK FOREIGN KEY (ROOM_ID) REFERENCES ROOM (ID)
);
...
(
	...
	CONSTRAINT MEMBER_ACCOUNT_UNIQUE UNIQUE (ACCOUNT)
);
...
(
	...
	CONSTRAINT PAY_METHOD_NAME_UNIQUE UNIQUE (NAME)
);
...
(
	...
	CONSTRAINT BOOKING_ORDER_CLIENT_ID_FK FOREIGN KEY (CLIENT_ID) REFERENCES MEMBER (ID),
	CONSTRAINT BOOKING_ORDER_ROOM_ID_FK FOREIGN KEY (ROOM_ID) REFERENCES ROOM (ID),
	CONSTRAINT BOOKING_ORDER_PAY_METHOD_ID_FK FOREIGN KEY (PAY_METHOD_ID) REFERENCES PAY_METHOD (ID)
);
