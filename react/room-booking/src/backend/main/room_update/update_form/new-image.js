                    ...
                    <Row>
                        <Col xs='auto'>
                            <Stack gap={4}>
                                        ...
                                        (n, index) => (
                                            <Stack direction='horizontal' gap={4} key={n}>
                                                <Form.Control type='file' id={`form_newImage${n}`} name={`form_newImage${n}`} 
                                                        onChange={e => this.onChange(e, n)} disabled={value.disabled} />
                                                <div style={{visibility : (index>0) ? 'block' : 'hidden'}}>
                                                    <Button variant='outline-primary' size='sm' onClick={e => this.onClickMinusBtn(e, n)}  disabled={value.disabled}>-</Button>
                                                </div>
                                            </Stack>
                                        )
                                    )
                                ...
                                <div>
                                    <Button variant='outline-primary' size='sm' disabled={value.disabled} onClick={this.onClickPlusBtn}>+</Button>
                                </div>
                            </Stack>
                        </Col>
                    </Row>
