    ...
    render() {
        ...
        return (
            <Form.Group as={Row}>
                ...
                <Col>
                    <Form.Control id='filter_totalRoomMin' type='number' value={value.valueMin} 
                ...
                <Col>
                    <Form.Control id='filter_totalRoomMax' type='number' value={value.valueMax} 
